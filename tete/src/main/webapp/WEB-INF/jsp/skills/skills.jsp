...
<body>
        ...
        <section class="sample-text-area">
			<div class="container box_1170">
				<h3 class="text-heading">제가 경험했던 기술들입니다.</h3>
				<p class="sample-text">
					100퍼센트 활용을 했다곤 할수없지만, 이미 경험했던 기술들은 다음 프로젝트에 활용하는데 있어 큰도움이 될 것입니다. 또한 새로운 기술에 적응하는데도 도움이 될 것입니다.
				</p>
			</div>
		</section>
						...
						<tr>
							<td>
								<div class="skill-imgs center">
									...
									<img src="/img/skills/skill-server-4.png" class="skill-img">
									<img src="/img/skills/skill-server-5.png" class="skill-img">
						...
						<tr>
							<td>
								<div class="skill-imgs center">
									...
									<img src="/img/skills/skill-web-4.png" class="skill-img">
						...
						<tr>
							<td>
								<div class="skill-imgs center">
									...
									<img src="/img/skills/skill-etc-4.png" class="skill-img">
