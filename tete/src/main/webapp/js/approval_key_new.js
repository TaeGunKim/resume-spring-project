    ...
    function kcp_AJAX()
    {
        ...
        if(ajax_flag)
        {
            ...
            var url    = "/payment/orderApprovalNew.json";
            ...
            var params = "?site_cd=" + form.site_cd.value
                       ...
                       + "&param_opt_2=" + form.param_opt_2.value
                       + "&param_opt_3=" + form.param_opt_3.value
            ...
            if ( req01_AJAX.status == 200 )
            {
                if ( req01_AJAX.responseText != null )
                {
                    ...
                    try
                    {
                        ...
                        if( form.response_type1.value == "JSON" )
                        {
                            StateChangeForJSON( req01_AJAX ); // JSON 방식일 경우
                        }
                        else if( form.response_type1.value == "XML" )
                        {
                            StateChangeForXML( req01_AJAX ); // XML 방식일 경우
                        }
                        else if( form.response_type1.value == "TEXT" || form.response_type1.value == "" )
                        {
